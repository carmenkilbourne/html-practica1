    ...
    return (
        ...
        <div className="max-w-screen-md mx-auto flex flex-col  justify-center">
            ...
            <p style="font-family:'Courier New';font-size:  0.875em;">
                Colocar y reponer productos en la zona de ventas de
                hipermercados bajo la supervisión del personal encargado de la
                sección donde se ubique. - Cargar y descargar los productos para
                transportarlos del almacén hasta el lugar de colocación, manual
                o mecánicamente.
            </p>
            <h5>Recepcionista</h5>
            <p style="font-family:'Courier New';font-size:  0.875em;">
            ...
            <h5>Tutora</h5>
            <p style="font-family:'Courier New';font-size:  0.875em;">
                Tutora de idiomas, como el Inglés, italiano, aleman, portugues,
                etc.
            </p>
